...
export default function ProjectsSection() {
  const projects: Project[] = [
    {
      ...
      description:
        "Developed a pipeline combining unsynchronized photogrammetry and LiDAR data, aligned point clouds using ICP and trained a 3D Gaussian Splatting model for high-fidelity reconstruction.",
      fullDescription:
        "This master's research project investigates hybrid 3D reconstruction for cultural heritage documentation by fusing unsynchronized photogrammetry and LiDAR datasets into metrically consistent models. The work demonstrates how neural rendering via 3D Gaussian Splatting can enhance photometric realism while maintaining metric accuracy using consumer-grade hardware.",
      technologies: [
        "COLMAP",
        "Open3D",
        "LiDAR",
      ...
      githubUrl: "https://github.com/nehith23/hybrid-3d-reconstruction",
    },
    {
      id: "2",
      title: "Graph-Based SLAM & ORB-SLAM2 Evaluation",
      description:
        "Modified ORB-SLAM2 to analyze feature selection and loop closure effects on trajectory estimation; benchmarked performance using COLMAP and EVO tools.",
      fullDescription:
        "This project documents major tasks in localization, mapping, and state estimation. It compares classical filtering methods (EKF) with modern graph-based optimization techniques (g2o/ORB-SLAM2) applied to real-world and benchmark datasets.",
    ...
    },
    {
      ...
      description:
        "Designed inspection path planning using TSP optimization and implemented centralized/decentralized swarm control strategies for multi-agent drones.",
      fullDescription:
        "Research progressing from single-agent path planning to multi-agent swarm coordination. Simulates structural inspection using Simulated Annealing for TSP and A* for collision-free 3D planning. Implementation of centralized vs decentralized control for formation flight.",
      technologies: [
        "Python",
        "ROS2",
        "Simulated Annealing",
    ...
    },
    {
      ...
      description:
        "Built neural networks to correct motor models and predict trajectories from Cartesian goals, integrated into a feedback control loop.",
      fullDescription:
        "Applying data-driven techniques to control a simulated 7-DoF Franka Panda robot. Learning correction terms for erroneous motor models and training regressors to predict full joint trajectories from Cartesian goals.",
      technologies: [
        "PyTorch",
        "Franka Panda",
        "Neural Networks",
    ...
    },
    {
      ...
      description:
        "Integrated EKF-based localization with MPC trajectory tracking, validated under sensor noise in PyBullet simulation.",
      fullDescription:
        "Robust localization and control system for a differential drive robot using Model Predictive Control (MPC) for real-time tracking and Extended Kalman Filter (EKF) for state estimation under noisy conditions.",
    ...
    },
    {
      ...
      description:
        "Designed morphology-shifting robots in PyBullet with adaptive 'Octopus' and 'Turtle' modes for planetary navigation.",
      fullDescription:
        "Concept for a self-reconfigurable soft robot for planetary exploration. Autonomously switches between 'Turtle Mode' for efficient rolling and 'Octopus Mode' for crawling traversal of unstructured terrain.",
      ...
      githubUrl:
        "https://github.com/nehith23/Self-Reconfigurable-Soft-Robot-for-Space-Exploration",
    },
    {
      id: "7",
      title: "Drone Landing on Astronomical Object",
      description:
        "Applied computer vision for segmentation, geometric estimation, and rotation analysis using stereo camera and LiDAR data.",
      fullDescription:
        "Perception algorithms for autonomous drone landing in space. Integrates segmentation, motion tracking, and rotation analysis to estimate geometric and dynamic properties of a target object.",
      ...
      githubUrl:
        "https://github.com/nehith23/Drone-Landing-on-Astronomical-Object",
    },
    {
      id: "8",
      title: "ROS2 Trajectory Navigation",
      description:
        "Full ROS2 pipeline for path smoothing, trajectory generation, and trajectory tracking for a differential-drive robot with reactive LIDAR obstacle avoidance.",
      fullDescription:
        "Full ROS2 pipeline for path smoothing, trajectory generation, and trajectory tracking for a differential-drive robot. Implements cubic spline interpolation, trapezoidal velocity profiles, and Pure Pursuit control with reactive LIDAR obstacle avoidance.",
      technologies: ["ROS2", "Python", "Gazebo", "Pure Pursuit", "Docker"],
      category: "Robotics",
      icon: Zap,
      highlights: [
        "Cubic spline path smoothing with C2 continuity",
        "Trapezoidal velocity profiling with acceleration constraints",
        "Pure Pursuit controller with LIDAR obstacle avoidance",
      ],
      challenges: [
        "Arc-length parameterization for uniform spline sampling",
        "Velocity modulation on high-curvature segments",
        "Separating core algorithm logic from ROS2 nodes for unit testability",
      ],
      outcomes: [
        "Mean cross-track error of 0.4cm over 9.59m path",
        "38 unit tests across all core modules",
        "Dockerised for reproducible deployment",
      ],
      githubUrl: "https://github.com/nehith23/trajectory-navigation",
    },
  ];
  ...
  return (
    <section
      id="projects"
      className="min-h-screen py-24 bg-background relative"
    >
          ...
          <div className="flex flex-wrap gap-4">
            {categories.map((category, idx) => (
              <button
                ...
                className={`text-sm tracking-widest uppercase py-2 px-1 relative transition-colors ${
              ...
              >
                ...
                >
                  <div className="flex justify-between items-start mb-6">
                    <Badge
                      variant="outline"
                      className="bg-accent/10 text-accent border-accent/20 hover:bg-accent/20 font-normal tracking-wide"
                    >
                      {project.category}
                    </Badge>
